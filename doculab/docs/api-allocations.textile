...
Creates a preview of the effect of adding compoonents to a subscription.
...
| @proration_scheme@ | The proration scheme for this allocation.  This is always 'prorate' for mid period transactions. |
...
{
  "allocation_preview": {
    "start_date": "2016-12-13T14:59:42Z",
    "end_date": "2017-01-07T20:29:07Z",
    "period_type": "prorated",
    "subtotal_in_cents": -1648,
    "total_tax_in_cents": 0,
    "total_discount_in_cents": 0,
    "total_in_cents": -1648,
    "existing_balance_in_cents": 40600
    direction": "downgrade",
    "proration_scheme": "prorate",
    "line_items": [
      {
        "transaction_type": "charge",
        "kind": "quantity_based_component",
        "amount_in_cents": -1648,
        "memo": "IP Addresses: 0 to 10 units",
      ...
      },
      {
        ...
        "kind": "quantity_based_component",
        "amount_in_cents": -1648,
        "memo": "IP Addresses: 0 to 5 units",
        "discount_amount_in_cents": 0,
        "taxable_amount_in_cents": 0,
        "component_id": 456
      }
