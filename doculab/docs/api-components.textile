...
* @enabled@ A boolean that controls whether the component is "On" for a given subscription.  Valid values are @true@/@false@, @on@/@off@, @yes@/@no@, @t@/@f@, @y@/@n@, @1@/@0@
...
* @enabled@ Provided when @kind@ is @on_off_component@
* @allocated_quantity@ Provided when @kind@ is @quantity_based_component@
