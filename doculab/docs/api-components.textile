...
* @price_per_unit_in_cents@ (*Note: this field is deprecated*) This represents the unit price prior to the Chargify upgrade to fractional cent component pricing. This field may no longer represent the correct unit price of the component. The @unit_price@ field should be used instead.
