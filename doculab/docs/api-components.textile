...
p(warning). The Components API is deprecated and will not receive new features. Chargify will continue to support it until further notice. For new development or updates, please use the "Allocations API":/api-allocations instead.
