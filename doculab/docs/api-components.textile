...
p(warning). Component proration was added to Chargify in September 2013. In order to utilize component proration when allocating through the API, you must use the "Allocations API":/api-allocations. The Components API will continue to be supported until further notice.
