...
Response: If the coupon is successfully removed, The string Coupon removed will be returned verifying the coupon has been removed. Otherwise, a '422 Unprocessable Entity' error will be returned.
