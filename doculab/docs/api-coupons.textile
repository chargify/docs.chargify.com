...
| Coupons<br/>@/coupons/<id>@ | "Retrieve coupon":#api-coupon-show | - | "Update coupon":#api-coupon-update | "Archive coupon":#api-coupon-archive |
...
* @duration_interval_unit@ and @duration_interval@ Description of the number of days/months the coupon should be applied. (See Recurring Options on "Coupons":/coupons for more details.)
* @end_date@ Coupon ending date.  If set, the coupon will expire at the end of the day in your site's time zone on this date. (See Expiration Date on "Coupons":/coupons for more details.)
* @conversion_limit@ Number of times this coupon (or any of its codes) may be added to a subscription
* @product_family_id@ The ID of the product family to which the coupon belongs.  The coupon can be added *only* to products in this product family.
* @created_at@ (Read Only) The creation date for this coupon
* @start_date@ (Read Only) Timestamp indicating when this coupon began to be valid. Defaults to @created_at@.
* @updated_at@ (Read Only) The date of last update for this coupon
* @archived_at@ Timestamp indicating when this coupon was archived
...
If you have multiple Product Families and you are retrieving a coupon, use the following:

URL: @https://<subdomain>.chargify.com/product_families/<product_family_id>/coupons/<coupon_id>.<format>@
Method: @GET@
Required Parameters: product_family_id, coupon_id
Response: The coupon
...
<pre><code>
{
	"coupon": {
		...
		"created_at": "2016-08-31T13:54:57-04:00",
		"updated_at": "2016-08-31T13:54:57-04:00",
		"start_date": "2016-08-31T13:54:57-04:00",
		"end_date": null,
		"percentage": 100,
		"recurring": false,
		"duration_period_count": null,
		"duration_interval": 1,
		"duration_interval_unit": "month",
		"allow_negative_balance": false,
		"archived_at": null,
...
If you have multiple Product Families and you are archiving a coupon, use the following:
...
h2(#api-coupon-validate). Validating a Coupon via the API
