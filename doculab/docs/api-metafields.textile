...
* @input_type@ - Can be @text@, @dropdown@, or @radio@.
* @enum@ - An array of allowed values for this metafield, if specifying an @input_type@ of @dropdown@ or @radio@.
...
In the above case, when metafields are given the @input_type@ of @dropdown@ or @radio@, and an @enum@ of allowed values, we will render a dropdown or radio buttons with those values on the hosted pages. Otherwise, a text input will be rendered, and customers will be able to enter any value.
