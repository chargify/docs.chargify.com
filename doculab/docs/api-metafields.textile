...
=======
Metafield are the place where you will set up your resource to accept additional data. It is scoped to the siet instead of a specific customer or subscription. Think of it as the key, and Metadata as the value on every record.
...
=======
* @scope@ - Limits where the attribute will be displayed. Can be empty or csv.
>>>>>>> fist pass at metafield/metadata documentation
