...
* @since_date@ Returns usages with a @created_at@ date greater than or equal to the one specified.
* @until_date@ Returns usages with a @created_at@ date less than or equal to the one specified.
