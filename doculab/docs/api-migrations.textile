...
* @product_id@ or @product_handle@: The ID or handle of the target Product.  Subscriptions may only be migrated to other products within the same Product Family, otherwise an "Invalid Product" error will be returned.
