...
* @product_id@ or @product_handle@: The ID or handle of the target Product. A Subscription can be migrated to another product.
  Note: If the component is not available in the new product, it will *not* be migrated.
