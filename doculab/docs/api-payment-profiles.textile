...
* @payment_profile@
** @payment_type@ (Optional) Default is @credit_card@.  May be @bank_account@ or @credit_card@.
...
* If you are using Authorize.net, you may elect to manually trigger a "retry":/api-subscriptions#retry for a past due subscription after a partial update.
