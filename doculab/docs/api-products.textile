...
* @return_url@ The URL a buyer is returned to after successful purchase.  See the section on "Return URLs and Parameters" [here](http://support.chargify.com/faqs/features/hosted-signup-page)
* @return_params@ The parameters string we will use in constructing your return URL.  See the section on "Return URLs and Parameters" [here](http://support.chargify.com/faqs/features/hosted-signup-page)
