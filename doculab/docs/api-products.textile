...
* @auto_create_signup_page@ A @true@ or @false@ value (default @false@) indicating whether or not you want a "Public Page":/public-pages-intro" to be automatically created for this product
