...
<pre><code>
Feature: Chargif XML API Product Create
  In order to integrate my app with Charigfy
  As a developer
  I want to create products via the Chargify XML API
  ...
  Scenario: Create a product successfully
    Given I have this XML prodcut data
    """
      <?xml version="1.0" encoding="UTF-8"?>
      <product>
