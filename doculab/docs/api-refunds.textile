*Note: Refunds are only supported for the following gateways:  Authorize.Net, Samurai, Braintree Blue, Stripe, eWay Rapid, Payeezy (First Data), Elavon, Pin Payments, CyberSource, Payment Express, Paymill, Litle, QuickPay, Orbital, Trust Commerce, and Moneris.*
