...
API V2 resources use different credentials than the V1 API.  If you receive a 401 Unauthorized response, please see the section on "API V2 Authentication":/chargify-direct-introduction#api-v2-auth in the "Chargify Direct Introduction":/chargify-direct-introduction .
...
** @country@ (Optional) The customer shipping address country, preferably in "ISO 3166-1 alpha-2":http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 format (i.e. “US”).
...
h4(#direct-custom). Chargify Direct Example with Custom Fields
...
h4(#direct-coupon). Chargify Direct Example with a Coupon Code
