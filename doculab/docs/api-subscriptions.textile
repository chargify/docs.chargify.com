...
@state@: The current state of the subscription. Please see the documentation for "Subscription States":/subscription-states.  Special values @expired_cards@, @expiring_next_month@, and @expiring_this_month@ may also be used.
