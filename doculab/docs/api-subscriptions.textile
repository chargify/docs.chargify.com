...
* @ref@ A valid referral code. (optional, see "Referrals":/referrals for more details).
* @components@ (Optional) An array of component ids and quantities to be added to the subscription.  See "API Quantity Component Allocations":/api-quantity-allocations for more information.
...
Listing subscriptions may also be filtered by supplying a @date_field@ along with a @start_date@ and/or @end_date@ and (optionally) the @direction@.
...
@direction@: The order to be applied to the @date_field@. Use @asc@ for ascending or @desc@ for descending.
...
Components may also be included in the import.  See "API Quantity Component Allocations":/api-quantity-allocations for more information.
