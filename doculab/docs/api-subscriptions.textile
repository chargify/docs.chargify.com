...
| Subscription<br/>@/subscriptions/<id>@ | Read subscription | - | Update subscription | Cancel subscription |
| Subscription<br/>@/subscriptions/<id>/payment_profiles/<payment_profile_id>/change_payment_profile@ | - | Change payment profile | - | - |
