...
You can request cancellation of a Subscription yourself by clicking "Initiate Cancelation" from the operations menu.
...
* You have the option of canceling immediately or at the end of the period, selecting either options means the customer's credit card will no longer be charged.
