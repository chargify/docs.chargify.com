...
Your Chargify Direct API ID and Password are different for each of your Sites, and can be found under Settings -> Chargify Direct in the Admin UI:

!/images/doculab/chargify-direct-credentials.png!
