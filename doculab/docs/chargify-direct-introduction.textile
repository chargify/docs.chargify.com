p(note). You must be on our *Small Business* plan ($129/month) to be eligible for Chargify Direct.  If you would like access to the feature, please "open a ticket":http://help.chargify.com/tickets/new and include the subdomain of the site you would like enabled.
