...
* Coupons are only applied when a recurring charge is assessed.
...
* Coupons will appear on a customer's record in the order of "charge, adjustment, payment".
...
If you set an **Expiration Date**, the coupon will no longer be redeemable after the end of the day (Eastern Standard Time).
