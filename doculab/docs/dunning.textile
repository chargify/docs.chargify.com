...
In this section, you choose how many times Chargify should automatically retry failed renewal attempts.  We will retry approximately every 24 hours, for as many attempts as you configure.  At the end of the retry period, you can take a "final action" on the subscription and optionally send an email.
...
Select *how many retries* you would like Chargify to perform before you take a "Final Action".  Entering "1" in this box will cause the Final Action to be taken upon the very first attempt to renew.
...
p(note). The "From Address" configured in this section will also be used as the "From Address" on your Final Action email.
