...
h2. Upcoming Renewal and End of Trial emails

The following variables are available for upcoming renewal and end of trial emails:
...
* @{{subscription.card_on_file?}}@ True/false value indicating whether or not there is a @payment_profile@ present
