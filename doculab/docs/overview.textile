...
Using Chargify, you will sell *Subscriptions* to your *Products*.  So to get started, you'll need to tell us what you sell. Setting up your Products involves giving them a name, price, recurring interval, available options and components, and more.

* View ""Define What You Sell"":/quick-start-products in the Quick Start Guide
* View the in-depth "section on Configuring Products":/product-intro

Before or after defining your Products, you'll also need to  "configure your Site":/quick-start-site.
...
# On your own website, by talking to "Chargify via our API":/selling-via-apiic.
