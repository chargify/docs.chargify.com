p(note).  Post-Backs have been deprecated and are no longer available.  Please use "Webhooks":/webhooks instead of Post-Backs.  Webhooks have more features and can be easier to use.  Post-Backs will continue to work until June 1, 2015, at which time we will no longer generate new Post-Backs.
