...
h2(#components). Pre-Populating Components
...
h3(#qty). Quantity-based components:

bc. ?components[][component_id]=16899&components[][allocated_quantity]=9

h3(#on-off). On/Off components:

bc. ?components[][component_id]=16899&components[][allocated_quantity]=1

Note:  Use 1 for "on" and 0 for "off"

h3(#metered). Metered components:

bc. ?components[][component_id]=12345&components[][unit_balance]=16
