...
*A component is available to only the products that you specify when creating or editing a component.*
...
h2. Creating/Configuring Components

To create any Component start on the "Setup" tab and click "Components".
...
!{width:640px}/images/doculab/prod-comp-3.png!
...
!/images/doculab/new-quant-comp.png!
...
Once you have created a Metered Component, it will appear under the Components link on the Settings tab. You can make changes to the component by clicking the 'Edit' link.

!{width:640px}/images/doculab/metered-comp.png!
...
Once you have created an On/Off Component, it will appear under the Components link on the Settings tab. You can make changes to the component by clicking the 'Edit' link.



h2. Setting Component allocations on Subscriptions

Once a Component has been defined and explicity associated with a Product, any Subscription to one of those Products may have usage or allocation data reported in order to assess charges for them at the end of the period.
