...
h3. Return URL and Parameters

In these fields, you may define a URL, optionally with dynamic parameters, to which the Hosted Payment Page would redirect after a successful signup.  The behavior of this field is covered further in the documentation on "Hosted Page Settings":/hosted-page-settings#return-url.  "Hosted Page Integation":/hosted-page-integration discusses the integration use-cases for these values.
