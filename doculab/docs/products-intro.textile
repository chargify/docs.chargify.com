...
Deleting products isn't support, but what is supported is archiving products. Archiving products remove the ability for new subscriptions to that product (either by signup or migration).
