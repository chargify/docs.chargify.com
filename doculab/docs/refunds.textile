*Note: Refunds are currently only supported for the following gateways - Authorize.Net, Braintree Blue, CyberSource, Elavon, eWay Rapid, First Data, Paymill, Pin Payments, Samurai, and Stripe*
