...
The API calls required to report usage are detailed in the documentation on the "Reporting Metered Components usage via the API":/api-components#reporting-metered-usage.
...
The API calls required to report allocated quantities are detailed in the documentation on the "Reporting Quantity-based Components usage via the API":/api-components#reporting-allocated-quantities.
...
The API calls required to report enabled status are detailed in the documentation on the "Reporting On/Off Components status via the API":/api-components#reporting-onoff-status.
