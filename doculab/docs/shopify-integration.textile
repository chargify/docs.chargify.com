The Chargify app allows you to subscribe your customers to the products they now buy as one-time purchases in your store. Rather than adding their purchases to the shopping cart, your customers will click “Signup” and then be directed to Chargify's customizable hosted signup pages. Once your customers have subscribed to the product in Chargify, you can use all of our great features to manage your recurring revenue business.
...
**IMPORTANT: Please do not delete the Chargify app from Shopify. If you do, please contact Chargify Support at 1 (800) 401-2414 or support@chargify.com so we can remove the Chargify installation before you reinstall.**
...
* Fill in the:
** Product Name
** Description (this description will appear on the hosted signup page where your customers signup for your recurring subscription products)
...
h2. Publishing Chargify Products To Shopify
...
h2. Verify The Setup Is Complete
...
Click on the “Signup” button to ensure the customer is brought to the Chargify hosted page for checkout instead of the Shopify cart.
...
h2. Replacing "Add to Cart" with "Signup" Button
...
h2. Automatic Order Creation Upon Signup/Renewal
...
<b>Shopify requires shipping information for valid Shopify “Orders” to be created.</b>
...
* DO NOT DELETE THE CHARGIFY APP FROM SHOPIFY. If you do, please contact Chargify so we can remove the integration from your Chargify account before you attempt to reinstall. 
...
<i>Note: There is also a 3rd party app available that allows your customers to manage their orders & subscriptions through their Shopify customer account. "https://apps.shopify.com/chargify-accounts-by-eshop-admin":https://apps.shopify.com/chargify-accounts-by-eshop-admin. This app has not been tested by Chargify, therefore we cannot vouch for its reliability and are unable to provide support should any issues occur.</i>
...
Currently, each Chargify product must be purchased separately. Your customers will need to purchase recurring products through the Chargify hosted signup page and any one-time Shopify products through the Shopify shopping cart. 

**How can my customers purchase more than a Quantity of 1?**
You can allow multiple quantities of the same recurring product to be purchased at one time by setting up product components and allowing your customer to choose the quantity (or add-on) on the Chargify hosted signup page: "https://docs.chargify.com/product-components":https://docs.chargify.com/product-components

**Will my Shopify variants get sent to Chargify?**
No. Variants selected on Shopify product pages do not get sent to the Chargify Hosted Signup Pages. Custom fields can be created in Chargify to allow customers to input text values for sizes, colors, and other variants that don’t add a cost to the subscription.
...
**Can I change the URL on my Chargify hosted page where my customers checkout?**
