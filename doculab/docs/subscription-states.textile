...
Indicates a canceled subscription.  This may happen at your request (via the API or the web interface) or due to an expiration of the dunning process without payment.  See the "Reactivation":/reactivation documentation for info on our to restart a canceled subscription.
