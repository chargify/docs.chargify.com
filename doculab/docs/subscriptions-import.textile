...
PLEASE NOTE: This is an advanced feature which is only recommended for merchants with technical experience in mapping data in CSV format. Limited support will be provided. If you do not feel comfortable with the procedures laid out below, please contact our support team at support@chargify.com or by phone 24/7 on (800) 401-2414.
...
PLEASE NOTE: XLSX files will need to be saved as CSV prior to upload.
...
PLEASE NOTE: The import job is aborted if 10 successive entries fail to create a subscription.  This can happen if the data is not formatted correctly, or if the gateway declines the initial authorization or charge.
...
Please contact us via help.chargify.com if you require assistance.  You can also reach us via email at support@chargify.com or by phone on (800) 401-2414.
