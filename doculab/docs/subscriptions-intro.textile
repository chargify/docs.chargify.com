...
The creation of a Subscription is analogous to receiving a signup.  There are 3 basic ways that Subscriptions are created: "via Hosted Payment Pages":/hosted-page-integration, "via the API":/api-integration, or manually via the UI.
