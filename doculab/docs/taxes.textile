...
h4. General Tax (i.e. US Sales Tax)
...
In order to be as flexible as possible, Chargify provides the ability to define your own tax scenarios. Taxes are comprised of one or more 'Tax Rules'. A Tax Rule specifies a geographic region and and a percentage rate to be applied to that region. The geographic region can be either an entire country, or a specific state/province within that country.
