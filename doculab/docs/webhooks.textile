...
| @signup_success@  | Any successful signup (Subscription created) via the API, admin UI, or Public Pages | @site@, @subscription@<sup>1,9</sup> |
...
| @payment_success@ | Any successful payment<sup>4</sup> "(example payload)":#payment-success-payload | @site@, @subscription@, @transaction@ |
| @payment_failure@ | Any failed payment attempt <sup>4</sup> "(example payload)":#payment-failure-payload |  @site@, @subscription@, @transaction@ |
...
| @subscription_product_change@ | A successful change from an old product to a new product for a Subscription. | @site@, @previous_product@, @subscription<sup>1</sup> |
| @subscription_card_update@ | Any change to the active Credit Card type payment profile.<sup>7,8</sup> | @site@, @subscription@, @product@, @previous_payment_profile@, @updated_payment_profile@ |
...
memo
timestamp</code></pre> |
| @upgrade_downgrade_success@  | Any successful upgrade/downgrade  | @site@, @subscription@<sup>1</sup>, @previous_product@ |
