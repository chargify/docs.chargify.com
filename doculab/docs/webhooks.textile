...
| @subscription_card_update@ | Any change to the active payment profile.<sup>7</sup> | @site@, @subscription@, @product@, @previous_payment_profile@, @updated_payment_profile@ |
...
site
subscription</code></pre> |
| @statement_closed@ | A statement closes ("Statement Events":#statement-events) | "example payload":#statement-closed-payload |
| @statement_settled@ | A statement settles ("Statement Events":#statement-events) | "example payload":#statement-settled-payload |
...
<pre><code>OpenSSL::HMAC.hexdigest(OpenSSL::Digest::Digest.new('sha256'), site.shared_key, webhook.body)</code></pre>
...
<pre><code>
{
    ...
    "payload" => {
        ...
        "previous_payment_profile" => {
            ...
            "vault_token" => "cus_5UXXXXXXXXXXhJ",
            "customer_vault_token" => "",
            "billing_address" => "",
            "billing_address_2" => "",
            "billing_state" => "",
        ...
        "updated_payment_profile" => {
            ...
            "expiration_year" => "2016",
            "current_vault" => "stripe",
            "vault_token" => "cus_5UXXXXXXXXXXXhJ",
            "customer_vault_token" => "",
            "billing_address" => "",
            "billing_address_2" => "",
            "billing_state" => "",
...
<pre><code>
{
    ...
    "payload": {
        ...
        "subscription": {
            "activated_at": "2015-01-10 09:27:24 -0500",
            "balance_in_cents": "0",
            "cancel_at_end_of_period": "false",
            "canceled_at": "",
            "cancellation_message": "",
            "created_at": "2015-01-10 09:27:22 -0500",
            "current_period_ends_at": "2015-01-11 15:17:16 -0500",
            "expires_at": "",
            "id": "7473993",
            "next_assessment_at": "2015-01-11 15:17:16 -0500",
            "payment_collection_method": "automatic",
            "snap_day": "",
            "state": "active",
            "trial_ended_at": "",
            "trial_started_at": "",
            "updated_at": "2015-01-10 15:17:16 -0500",
            "current_period_started_at": "2015-01-10 15:17:13 -0500",
            "previous_state": "active",
            "signup_payment_id": "81122593",
            "signup_revenue": "30.00",
            "delayed_cancel_at": "",
            "coupon_code": "",
            "total_revenue_in_cents": "3195",
            "product_price_in_cents": "195",
            ...
            customer: {
                ...
                "city": "",
                "country": "",
                "created_at": "2015-01-10 09:27:21 -0500",
                "email": "john@example.com@",
                "first_name": "John",
                "id": "7332448",
                "last_name": "Doe",
                "organization": "",
                "phone": "",
                "portal_customer_created_at": "2015-01-10 14:44:48 -0500",
                "portal_invite_last_accepted_at": "",
                "portal_invite_last_sent_at": "",
                "reference": "",
                "state": "",
                "updated_at": "2015-01-10 14:44:48 -0500",
                "verified": "false",
                "zip": "",
            },
            credit_card: {
              ...
              "vault_token": "cus_5UXXXXXXXXXXfI",
              "payment_type": "credit_card",
          },
            product: {
                "accounting_code": "",
                "archived_at": "",
                "created_at": "2015-01-04 12:3:31 -0500",
                "description": "Daily test product",
                "expiration_interval": "",
                "expiration_interval_unit": "never",
                "handle": "test-2",
                "id": "3618724",
                ...
                "trial_price_in_cents": "",
                "update_return_url": "",
                "updated_at": "2015-01-04 12:35:31 -0500",
                "product_family": {
                    "accounting_code": "",
        ...
        "previous_product": {
            "accounting_code": "",
            "archived_at": "",
            "created_at": "2015-01-10 09:23:47 -0500",
            "description": "",
            "expiration_interval": ",
            "expiration_interval_unit": "never",
            "handle": "annual-plan",
            ...
            "trial_price_in_cents": "",
            "update_return_url: "",
            "updated_at": "2015-01-10 09:23:47 -0500",
            "product_family": {
                "accounting_code": "",
                "description": "Test product family",
                "handle": "test-family",
...
<pre><code>
{
    ...
    "payload": {
        ...
        "customer_reference": "",
        "gateway_transaction_id": ch_15XXXXXXXXXXXYP,
        "gateway_order_id": "",
        "gateway_used": "stripe",
        "masked_card_number": "XXXX-XXXX-XXXX-1881",
        "memo": "example refund",
        "payment_amount_in_cents": "195",
        "payment_id": "81145688",
        "subscription_id": "7473993",
        "timestamp": 2015-01-11T03:32:17Z
    }
}
</code></pre>
...
<pre><code>
{
    ...
    "payload": {
        "site": {
            "id": "24649",
            "subdomain": "acme-test",
            "subscription_id": "74783293",
            "timestamp": "2015-01-11T03:31:25Z"
        },
        "amount_in_cents": "250",
        "customer_id": "7332448",
        "customer_email": "john@example.com",
